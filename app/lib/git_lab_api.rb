...
class GitLabAPI
  ...
  def create_issue(project_id, content, labels, access_token)
    rest_client.post("/projects/#{project_id}/issues", { verify: false, body: { description: content, labels: labels, access_token: access_token } })
  end
